...
const { updateBookSchema, addBookSchema } = require("../validators/bookValidator");

const { addBooks, getAllBooks, getBookById, searchBooks, updateBook, deleteBook } = require("../../controllers/book-controller");
...
router.post("/",            verifyToken, isAdmin, addBooks);        // POST /api/books
